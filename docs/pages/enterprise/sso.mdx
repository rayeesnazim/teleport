...
<TileSet>
  <Tile icon="bolt" title="Get started with GitHub SSO" href="../setup/admin/github-sso.mdx">
    Configure GitHub SSO for SSH, Kubernetes, databases, desktops and webapps.
  </Tile>
</TileSet>

Read the docs as a user of another Teleport edition to learn about our
integrations with other SSO providers:
...
Follow our guides to get started with Teleport and your SSO provider:
