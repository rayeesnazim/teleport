...
| `--rds-discovery` | List of AWS regions the Database Service will discover for RDS/Aurora instances. |
| `--redshift-discovery` | List of AWS regions the Database Service will discover for Redshift instances. |
